...
import com.example.mypeeloff.bandageanimation.BandageReveal
import com.example.mypeeloff.ui.theme.ComopseTestTheme
                ...
                Surface(
                    ...
                    Column(Modifier.padding(16.dp), verticalArrangement = spacedBy(8.dp)) {
                        ...
                        BandageReveal(behindContent = {
                            ...
                            Card("IKRAM KHAN", R.drawable.puzzle, 3.dp)
                        })
                        BandageReveal(behindContent = {
                            CardBehindContent(it)
                        }, content = {
                            Card("KOTLIN", R.drawable.coding, 3.dp)
                        })
